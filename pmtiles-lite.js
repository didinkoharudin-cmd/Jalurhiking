(function(global){
  ...
  async function decompress(buffer,compression){
    ...
    if(compression===Compression.Brotli)throw new Error('PMTiles dengan kompresi internal Brotli belum didukung V3.');
    if(compression===Compression.Zstd)throw new Error('PMTiles dengan kompresi internal Zstd belum didukung V3.');
