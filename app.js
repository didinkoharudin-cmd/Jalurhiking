...
function protoLayers(source='base'){
  return [
    {id:'background',type:'background',paint:{'background-color':'#08130d'}},
    {id:'earth',type:'fill',source,'source-layer':'earth',paint:{'fill-color':'#122419'}},
    {id:'landuse',type:'fill',source,'source-layer':'landuse',paint:{'fill-color':['match',['get','kind'],'forest','#12301d','park','#1b3d27','grass','#29452d','farmland','#393923','residential','#202b22','#1a2d20'],'fill-opacity':['interpolate',['linear'],['zoom'],5,.72,15,.9]}},
    {id:'water',type:'fill',source,'source-layer':'water',paint:{'fill-color':'#173d4d'}},
    {id:'water-outline',type:'line',source,'source-layer':'water',minzoom:9,paint:{'line-color':'#356e80','line-width':['interpolate',['linear'],['zoom'],9,.35,18,1.1],'line-opacity':.65}},
    {id:'waterways',type:'line',source,'source-layer':'water',paint:{'line-color':'#4b879c','line-width':['interpolate',['linear'],['zoom'],10,.65,16,1.5,22,2.7],'line-opacity':.9}},
    {id:'boundaries',type:'line',source,'source-layer':'boundaries',paint:{'line-color':'#738078','line-dasharray':[3,3],'line-width':['interpolate',['linear'],['zoom'],8,.55,18,1.2],'line-opacity':.5}},
    {id:'roads-casing',type:'line',source,'source-layer':'roads',filter:['!', ['match',['get','kind'],['path','track'],true,false]],paint:{'line-color':'#06100a','line-width':['interpolate',['linear'],['zoom'],8,1.5,15,5.5,18,8,22,11]}},
    {id:'roads',type:'line',source,'source-layer':'roads',filter:['!', ['match',['get','kind'],['path','track'],true,false]],paint:{'line-color':['match',['get','kind'],'highway','#d5b06b','major_road','#c2a46b','minor_road','#9b9a80','service','#777b68','#8f927d'],'line-width':['interpolate',['linear'],['zoom'],8,.55,15,2.35,18,3.7,22,5.5]}},
    {id:'trails-casing',type:'line',source,'source-layer':'roads',filter:['match',['get','kind'],['path','track'],true,false],paint:{'line-color':'#06100a','line-width':['interpolate',['linear'],['zoom'],11,1.6,16,3.4,20,5.6,22,7]}},
    {id:'trails',type:'line',source,'source-layer':'roads',filter:['match',['get','kind'],['path','track'],true,false],paint:{'line-color':'#d9c88e','line-width':['interpolate',['linear'],['zoom'],11,.75,16,1.65,20,2.8,22,3.6],'line-dasharray':[2.2,1.35]}},
    {id:'buildings',type:'fill',source,'source-layer':'buildings',minzoom:13,paint:{'fill-color':'#495a4d','fill-opacity':['interpolate',['linear'],['zoom'],13,.34,18,.82]}},
    {id:'building-outline',type:'line',source,'source-layer':'buildings',minzoom:16,paint:{'line-color':'#748177','line-width':['interpolate',['linear'],['zoom'],16,.35,22,1.15],'line-opacity':.65}}
  ];
}
