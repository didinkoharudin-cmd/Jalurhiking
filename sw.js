const CACHE='jalurnusa-v4-2-professional';
const SHELL=['./','./index.html','./styles.css?v=4.2.0','./app.js?v=4.2.0','./pmtiles-lite.js','./manifest.webmanifest','./icon.svg','./data/mountains.json'];
